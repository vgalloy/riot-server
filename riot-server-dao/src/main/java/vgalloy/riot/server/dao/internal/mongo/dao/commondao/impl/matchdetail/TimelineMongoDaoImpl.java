...
import vgalloy.riot.server.dao.internal.mongo.entity.dataobject.TimelineDpo;

/**
 * @author Vincent Galloy
 *         Created by Vincent Galloy on 28/05/16.
 */
public final class TimelineMongoDaoImpl extends AbstractDao<Timeline, TimelineDpo> implements TimelineDao {
     ...
     */
    public TimelineMongoDaoImpl(String databaseUrl, String databaseName) {
