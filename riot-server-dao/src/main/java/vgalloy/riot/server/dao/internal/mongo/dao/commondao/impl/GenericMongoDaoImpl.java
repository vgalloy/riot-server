...
import vgalloy.riot.server.dao.internal.mongo.dao.commondao.GenericDao;
 ...
 */
public final class GenericMongoDaoImpl<DTO, DATA_OBJECT extends AbstractDataPersitenceObject<DTO>> implements GenericDao<DTO, DATA_OBJECT> {
     ...
     */
    public GenericMongoDaoImpl(JacksonDBCollection<DATA_OBJECT, String> collection) {
