...
import vgalloy.riot.server.dao.internal.mongo.entity.dataobject.RankedStatsDpo;

/**
 * @author Vincent Galloy
 *         Created by Vincent Galloy on 28/05/16.
 */
public final class RankedStatsMongoDaoImpl extends AbstractDao<RankedStatsDto, RankedStatsDpo> implements RankedStatsDao {
     ...
     */
    public RankedStatsMongoDaoImpl(String databaseUrl, String databaseName) {
