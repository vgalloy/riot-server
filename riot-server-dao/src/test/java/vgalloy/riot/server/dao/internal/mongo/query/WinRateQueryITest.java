package vgalloy.riot.server.dao.internal.mongo.query;
...
public class WinRateQueryITest {
    ...
    private final MatchDetailDao matchDetailDao = new MatchDetailMongoDaoImpl(URL + ":" + PORT, "riotTest");
    private final TimelineDao timelineDao = new TimelineMongoDaoImpl(URL + ":" + PORT, "riotTest");
    private final MatchDetailDao globalMatchDetailDao = new GlobalMatchDetailMongoDaoImpl(timelineDao, matchDetailDao);
    private final ChampionDao dao = new ChampionMongoDaoImpl(URL + ":" + PORT, "riotTest");
