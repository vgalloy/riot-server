package com.vgalloy.riot.server.dao.internal.query;
 ...
 */
public final class DatabaseCleanerHelperIT {

    private static final Logger LOGGER = LoggerFactory.getLogger(DatabaseCleanerHelperIT.class);
